...
<div class="header">
  ...
  <div class="title" style="float:right;margin-left:950px; margin-top:-100px;">
			...
			<br>
				...
				<form action="Editbook" method="post">
					<div class="form-group">
						<label for="BookCode" >Book Code</label> <input class="form-control"
							type="text" id="bookCode"
							value="${book.getBookCode()}" name="bookCode" readonly>

					</div>
					<div class="form-group">
						<label for="BookName" >Book Name</label> <input class="form-control"
							type="text"  id="bookName"
					...
					<div class="form-group">
						<label for="AddedOn" >Added On</label> <input
							type="text" id="addedOn" class="form-control"
